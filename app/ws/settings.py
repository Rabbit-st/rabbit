...
define('maxconn', type=int, default=99,
...
def get_app_settings(options):
    settings = dict(
        #template_path=os.path.join(base_dir, 'ws', 'templates'),
        #static_path=os.path.join(base_dir, 'ws', 'static'),
